...
var testProjectDirectory2 = '/home/ivan/NetBeansProjects/app-ionicundo/www';
...
gulp.task('build', function() {
    gulp.src(sourceFiles)
        .pipe(plumber())
        .pipe(concat('ionic-undo.js'))
        .pipe(gulp.dest('./dist/'))
        .pipe(uglify())
        .pipe(rename('ionic-undo.min.js'))
        .pipe(gulp.dest('./dist'))
...
gulp.task('sass', function(done) {
    gulp.src('./style/scss/ionic-undo.scss')
        .pipe(sass())
